...
import { ChevronDown, Send, Pin } from 'lucide-react'
...
export function RouteComments({ routeId, comments }: RouteCommentsProps) {
              ...
              <div key={comment.id} className="flex items-start gap-2.5 py-2">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-baseline gap-1.5">
                    ...
                    {comment.pinned && (
                      <Pin className="w-2.5 h-2.5 text-atlantic-blue inline-block" />
                    )}
